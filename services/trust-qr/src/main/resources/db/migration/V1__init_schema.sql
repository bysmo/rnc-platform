...
-- Exemple:
-- CREATE TABLE trust_qr.entity_example (
...
-- );
-- CREATE INDEX idx_entity_example_status ON trust_qr.entity_example(status) WHERE NOT deleted;
-- CREATE INDEX idx_entity_example_created_at ON trust_qr.entity_example(created_at);
